...
int main() 
{
	...
	{
		float arrMinasdResult[6] = {0.000000, -1.200000, 2.000000, 3.000000, 4.000000, 0.000000};
		printArrayln(arrMinasdResult, 6);
	}
	int arriVal[5] = {0, -1, 2, 3, 4};
	float arrfVal[5] = {-6.000000, 1.200000, 2.000000, 3.000000, 4.000000};
	float arrfVal2[5] = {-6.000000, 1.200000, 2.000000, 3.000000, 4.000000};
